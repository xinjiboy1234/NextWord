...
import { getCefrMeta, DIMENSION_HINTS } from '../lib/cefrMeta'
...
export function LevelDashboardPage() {
  ...
  if (loading) {
    return <p style={{ fontSize: 'var(--text-sm)', color: 'var(--muted)' }}>加载等级面板...</p>
  }
  ...
  return (
    <div className="stack stack-md">
      <section className="level-hero" style={{ textAlign: 'center', padding: 'var(--space-8) 0' }}>
