...
API_BASE = os.environ.get("NEXTWORD_API_BASE", "http://localhost:5108")
DASHSCOPE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions"
DASHSCOPE_MODEL = "qwen-plus"
DB_CONTAINER = "nextword-postgres-1"
DB_NAME = os.environ.get("NEXTWORD_SIM_DB", "nextword_qa_t034")
DB_USER = "nextword"
...
def do_free_expression(api, rng, user_level, day_log):
    ...
    # T-034 验收探针：响应 graduatedWords（毕业时刻可见口径）
    graduated = res.get("graduatedWords") or []
    if graduated:
        log_anomaly("graduation", f"毕业词: {graduated}")
